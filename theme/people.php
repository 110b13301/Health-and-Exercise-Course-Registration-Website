...
// 執行SQL查詢
$sql = "SELECT id, account, password, name, sex, year, month, day, telephone, cellphone, address, email, url, comment FROM users";
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h1 class="display-1 text-white font-weight-bold font-primary">會員管理</h1>
        <?php
        if($_SESSION['check_status']=="login_ok"){
